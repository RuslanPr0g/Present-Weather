    ...
    request({ url, json: true }, (error, { body }) => {
        if (error) {
            ...
            if(units === 'si')
                ...
                callback(undefined, body.daily.data[0].summary + ' It is currently ' + _temperature + _desTemp + ' degrees out. There is a ' + body.currently.precipProbability + '% chance of rain.')
        }
    })
}
